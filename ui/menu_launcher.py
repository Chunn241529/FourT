...
class MenuLauncher:
    ...
    def show_feature_restriction(
        ...
        response = messagebox.askyesno(f"Tính năng {feature_name}", msg, icon="info")
        if response:
            self.open_upgrade()
    ...
    def show_midi_restriction(self):
        ...
        self.show_feature_restriction(
            Features.MIDI_PLAYBACK, "Auto Music", "Thời gian dùng thử đã kết thúc."
        )
