...
_translations: Dict[str, Dict[str, str]] = {
    "vi": {
        ...
        "sequence_recorder": "Sequence recorder",
        "sequence_recorder_pro": "Sequence recorder (PRO)",
        "sequence_combo": "Sequence combo",
        "sequence_combo_pro": "Sequence combo (PRO)",
        ...
        # Sequence Recorder
        "sequence_helps": "Tính năng này giúp:\n• Ghi lại thao tác\n• Phát lại tự động",
        # WWM Combo
        ...
        "server_offline_msg": "⚠️ Không thể kết nối server.\nVui lòng nhập License Key để kích hoạt gói cước.",
        ...
        "feature_not_available_basic": "Tính năng này chỉ có ở gói Plus trở lên.",
        ...
        "converting": "⏳ Đang chuyển đổi... [30 giây - 1 phút]",
        ...
        "playlist_limit_msg": "Đã đạt giới hạn số bài hát của gói cước.\nVui lòng nâng cấp!",
        "songs_added": "Đã thêm {count} bài",
        ...
        # Sequence Recorder
        "sequence_library": "📚 Library",
        "no_sequences": "Chưa có sequence nào",
        "confirm_delete": "Xác nhận",
        "delete_sequence": "Xóa sequence '{name}'?",
        "cannot_delete_sequence": "Không thể xóa sequence: {error}",
        "timeline_reorder": "Timeline (Drag to Reorder)",
        "clear_all": "🗑 Clear All",
        "add_delay": "⏳ + Delay",
        "trigger": "Trigger:",
        "save_to_library": "💾 Save to Library",
        "active_background": "Active Background Sequences",
        "add_current_active": "+ Add Current to Active",
        "sequence_ready": "Ready",
        "recording": "🔴 Recording...",
        "sequence_name": "Sequence Name",
        "enter_sequence_name": "Enter sequence name:",
        "sequence_saved": "Sequence saved!",
        "sequence_save_error": "Cannot save sequence",
        # WWM Combo
        ...
        "afk_warning": "⚠️ Lưu ý: Không nên treo máy (AFK) để farm tài nguyên để đảm bảo an toàn tài khoản.",
        ...
        # Maintenance/Dev
        "maintenance_title": "⚠️ Bảo trì",
        "maintenance_msg": "Tính năng '{feature}' đang được bảo trì.\nChúng tôi đang nỗ lực nâng cấp để phục vụ bạn tốt hơn.",
        "develop_title": "🚧 Đang phát triển",
        "develop_msg": "Tính năng '{feature}' đang được phát triển.\nSẽ sớm ra mắt trong phiên bản tới!",
        "understood": "Đã hiểu",
    },
    "en": {
        # Menu Launcher
        ...
        # Sequence Recorder
        "sequence_helps": "This feature helps:\n• Record actions\n• Auto playback",
        # WWM Combo
        ...
        "server_offline_msg": "⚠️ Cannot connect to server.\nPlease enter a License Key to activate your package.",
        ...
        "playlist_limit_msg": "Playlist limit reached for current package.\nPlease upgrade!",
        "songs_added": "Added {count} songs",
        ...
        # Sequence Recorder
        "sequence_library": "📚 Library",
        "no_sequences": "No sequences yet",
        "confirm_delete": "Confirm",
        "delete_sequence": "Delete sequence '{name}'?",
        "cannot_delete_sequence": "Cannot delete sequence: {error}",
        "timeline_reorder": "Timeline (Drag to Reorder)",
        "clear_all": "🗑 Clear All",
        "add_delay": "⏳ + Delay",
        "trigger": "Trigger:",
        ...
        "load_combo": "📂 Load Combo",
        "empty_combo": "Create a combo first!",
        "afk_warning": "⚠️ Note: Do not AFK farm resources to ensure account safety.",
        "save_template": "Save Template",
        "enter_template_name": "Enter template name:",
        "template_exists": "Template '{name}' exists. Overwrite?",
        "template_saved": "Template '{name}' saved!",
        ...
        "maintenance_msg": "The feature '{feature}' is under maintenance.\nWe are working hard to upgrade it for better service.",
        "develop_title": "🚧 Under Development",
        "develop_msg": "The feature '{feature}' is under development.\nIt will be available soon in the next version!",
