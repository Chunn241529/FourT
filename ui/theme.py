...
class RoundedButton(tk.Canvas):
    ...
    def __init__(self, parent, text, command=None, kind='secondary', 
                 width=100, height=32, radius=8, **kwargs):
...
class GradientCard(tk.Frame):
    ...
    def __init__(self, parent, title=None, **kwargs):
        ...
        self.configure(relief='flat', bd=1, highlightbackground=COLORS['border'],
...
class ModernCheckbox(tk.Canvas):
    ...
    def __init__(self, parent, text="", variable=None, command=None, **kwargs):
        ...
        super().__init__(parent, width=total_width, height=self.size + 4,
                        bg=kwargs.pop('bg', COLORS['bg']), highlightthickness=0, **kwargs)
    ...
    def _draw(self):
        ...
        if self._check_scale > 0:
            ...
            self.create_line(check_points, fill='white', width=2, capstyle='round', joinstyle='round')
        
        # Text label
        self.create_text(s + 10, s/2 + 2, text=self.text, anchor='w',
...
class ModernRadioButton(tk.Canvas):
    ...
    def __init__(self, parent, text="", variable=None, value=None, command=None, **kwargs):
        self.size = kwargs.pop('size', 20)
        self.text = text
