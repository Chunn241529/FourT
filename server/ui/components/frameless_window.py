...
class FramelessWindow(tk.Toplevel):
    ...
    def _create_controls(self):
        ...
        for text, command, hover_color in buttons:
            ...
            # Bind events
            btn.bind('<Enter>', lambda e, b=btn, hc=hover_color: b.configure(bg=hc, fg='white'))
            btn.bind('<Leave>', lambda e, b=btn: b.configure(bg=colors['bg'], fg=colors['fg']))
