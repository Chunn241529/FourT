...
class MacroPlayer:
    ...
    def play(self, events, on_finish=None, loop_count=1, speed=1.0, randomize=True):
        """
        ...
        threading.Thread(target=self._play_thread, args=(events, on_finish, loop_count), daemon=True).start()
        ...
        while self.running:
            ...
            for event in events:
                ...
                if event_type == "mouse_click":
                    ...
                    button = getattr(mouse.Button, data["button"].split('.')[-1], mouse.Button.left)
